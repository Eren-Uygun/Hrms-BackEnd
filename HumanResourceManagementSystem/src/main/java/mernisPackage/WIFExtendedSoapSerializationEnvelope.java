...
public class WIFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(WIFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new WIFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static WIFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static WIFDateTimeConverter dateTimeConverter = new WIFStandardDateTimeConverter();

    public WIFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WIFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WIFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=WIFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,WIFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=WIFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
