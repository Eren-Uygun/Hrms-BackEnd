...
public class WIFKPSPublicSoap
{
    ...
    public WIFKPSPublicSoap(){}

    public WIFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public WIFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        WIFExtendedSoapSerializationEnvelope envelope= new WIFExtendedSoapSerializationEnvelope(WIFExtendedSoapSerializationEnvelope.VER11);
